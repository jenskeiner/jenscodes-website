...
declare namespace lunr {
    /**
     * TinySegmenter for Japanese text segmentation
     */
    class TinySegmenter {
    ...
    /**
     * Optional segmenter instance for languages that require it
     */
    ...
    namespace Builder {
         ...
         */
        type Plugin = (this: Builder, ...args: unknown[]) => void;
    }
    ...
    class Builder {
         ...
         */
        invertedIndex: Record<string, Record<string, { fieldName: Record<string, unknown> }>>;

        /**
         *  Keeps track of document term frequencies.
         */
        documentTermFrequencies: Record<string, Record<string, number>>;
         ...
         */
        field<T, K extends keyof T>(
            fieldName: string,
            attributes?: {
                boost?: number | undefined;
                extractor?: ((doc: T) => T[K] | string) | undefined;
            },
        ): void;
         ...
         */
        add(doc: unknown, attributes?: { boost?: number | undefined }): void;
         ...
         * @param plugin The plugin to apply.
         */
        use(plugin: Builder.Plugin, ...args: unknown[]): void;
    }
    ...
    /**
     * lunr.Index performs a search against the index using lunr query syntax.
     *
    ...
    class MatchData {
         ...
         */
        constructor(term: string, field: string, metadata: Record<string, unknown>);
    ...
    class Pipeline {
         ...
         */
        static load(serialised: string[]): Pipeline;
    ...
    namespace Query {
        ...
        interface Clause {
            ...
            wildcard: number;
            /** The presence of this term in a document. */
            presence: Query.presence;
        }

        /**
         * An object containing options for a query clause specified by {@link lunr.Query#term}.
         */
        interface TermOptions {
            ...
            /** Whether the term should be passed through the search pipeline. */
            usePipeline?: boolean | undefined;
            /** Whether the term should have wildcards appended or prepended. */
            wildcard?: number | undefined;
            /** The type of presence this clause requires. */
    ...
    class Query {
         ...
         * })
         */
        term(term: string | string[] | Token | Token[], options?: Query.TermOptions): Query;
    }
    ...
    class Token {
         ...
         */
        constructor(str?: string, metadata?: Record<string, unknown>);
    ...
    class TokenSet {
         ...
         */
        fromFuzzyString(str: string, editDistance: number): TokenSet;
    ...
    namespace tokenizer {
        ...
        /**
         * A table for character substitutions used by the tokenizer.
         */
        let table: number[][];
    }
